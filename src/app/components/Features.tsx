...
const Features = () => {
  return (
    <section className="flex-col flex justify-center items-center overflow-hidden bg-[url('/feature-bg.png')] bg-center bg-no-repeat py-24">
      <div className="mx-auto max-w-[1100px] px-6 lg:px-20 3xl:px-0 relative w-full flex justify-end">
        ...
        <div className="z-20 flex w-full flex-col lg:w-[60%]">
          <div className="relative">
            <Image
              ...
              width={50}
              height={50}
              className="absolute left-[-5px] top-[-40px] w-10 lg:w-[50px] md:top-[-50px] xl:top-[-50px]"
            />
            <h2 className="text-[40px] font-[700] lg:text-[40px] lg:font-[700]">
              Our Features
            </h2>
          </div>
...
const FeatureItem = ({ title, icon, description }: FeatureItem) => {
  return (
    <li className="flex w-full flex-1 flex-col items-start">
      ...
      <h2 className="text-[20px] font-[700] lg:text-[20px] lg:font-[700] mt-5 capitalize">
        {title}
      </h2>
